...
public class GoogleCloudStorageFileOutputWriter extends OutputWriter<ByteBuffer> {
  ...
  private static void copy(GcsFilename from, GcsOutputChannel toChannel) throws IOException {
    ...
    GcsInputChannel fromChannel = GCS_SERVICE.openReadChannel(from, 0);
    if (fromChannel!=null) {
  ...
  public String toString() {
    return "com.example.yingchen.myapplication.backend.GoogleCloudStorageFileOutputWriter [file=" + file + ", mimeType=" + mimeType
