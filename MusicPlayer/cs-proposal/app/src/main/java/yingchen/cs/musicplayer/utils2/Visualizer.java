package yingchen.cs.musicplayer.unused;
...
public class Visualizer extends View {
    ...
    public void link(MediaPlayer player)
    {
        ...
        mVisualizer = new android.media.audiofx.Visualizer(player.getAudioSessionId());
        mVisualizer.setCaptureSize(android.media.audiofx.Visualizer.getCaptureSizeRange()[1]);

        // Pass through Visualizer data to VisualizerView
        android.media.audiofx.Visualizer.OnDataCaptureListener captureListener = new android.media.audiofx.Visualizer.OnDataCaptureListener()
        {
            @Override
