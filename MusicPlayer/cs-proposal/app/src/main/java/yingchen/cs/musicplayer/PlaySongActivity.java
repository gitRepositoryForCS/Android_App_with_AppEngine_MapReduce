...
import yingchen.cis690.musicplayer.visualizer.VisualizerView;
import yingchen.cis690.musicplayer.visualizer.renderer.BarGraphRenderer;
import yingchen.cis690.musicplayer.visualizer.renderer.CircleBarRenderer;
import yingchen.cis690.musicplayer.visualizer.renderer.CircleRenderer;
import yingchen.cis690.musicplayer.visualizer.renderer.LineRenderer;
...
public class PlaySongActivity extends ActionBarActivity implements MediaController.MediaPlayerControl {
    ...
    private ServiceConnection musicConnection = new ServiceConnection(){
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            setController();
               songView = (ListView)findViewById(R.id.controller);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSongList =   this.getIntent().getParcelableExtra("songs");
