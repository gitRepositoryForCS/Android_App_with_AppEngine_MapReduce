...
public class TestHDF52 {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String path = "/Users/yingchen/Documents/aaa_report/report&books/MillionSongSubset/data/A/A/A";



        File fileToWrite = new File("bigdatafile.txt");
